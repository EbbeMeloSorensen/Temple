...
public class DialogueSession : IDialogueSession
{
    ...
    public DialogueSession()
    {
        var vertices = new List<LabelledVertex>
        {
            ...
            new("Well, we've had to lock up the cellar because of the horde of rats that suddenly showed up down there. Clear them out for me, and I'll give you the key to the sewer gate and a little gold to help you get back on your feet. What do you say?"),
        ...
        _graph.AddEdge(new LabelledEdge(12, 16, "I'll go speak to him, then."));
